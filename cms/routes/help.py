...
ALLOWED_TOPICS = {'general', 'dashboard', 'cases', 'clients', 'subjects',
                  'spiderfoot', 'search', 'settings',
                  'reminders', 'exports', 'financials', 'comments', 'audit',
                  'social', 'lookups', 'users'}
