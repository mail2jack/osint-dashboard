...
from ..validation import validate, VesselLookupSchema, VesselUpdateSubjectSchema, VesselFindingSchema
    ...
    if data.get('vessel_data'):
        ...
        if isinstance(vd, str):
            try:
                ...
                logger.warning("vessel_data JSON decode failed, trying ast.literal_eval")
