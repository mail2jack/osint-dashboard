...
def register_system_routes(app: Flask) -> None:
    ...
    def get_config_api() -> flask.Response:
        ...
        return jsonify({
            ...
            'twochat_configured': bool(Setting.get('twochat_api_key') and Setting.get('twochat_whatsapp_number')),
...
def _build_openapi_spec() -> dict:
    ...
    return {
        ...
        'paths': {
            '/api/email': {
                'post': {
                    ...
                    'requestBody': {
                        'required': True,
                        'content': {'application/json': {'schema': {'$ref': '#/components/schemas/EmailQuery'}}}},
            ...
            '/api/ip': {
                'post': {
                    ...
                    'requestBody': {
                        'required': True,
                        'content': {'application/json': {'schema': {'$ref': '#/components/schemas/IPQuery'}}}},
            ...
            '/api/domain': {
                'post': {
                    ...
                    'requestBody': {
                        'required': True,
                        'content': {'application/json': {'schema': {'$ref': '#/components/schemas/DomainQuery'}}}},
            ...
            '/api/openkvk': {
                'post': {
                    ...
                    'requestBody': {
                        'required': True,
                        'content': {'application/json': {'schema': {'$ref': '#/components/schemas/OpenKVKQuery'}}}},
            ...
            '/api/webcam': {
                'post': {
                    ...
                    'requestBody': {
                        'required': True,
                        'content': {'application/json': {'schema': {'$ref': '#/components/schemas/WebcamQuery'}}}},
            ...
            '/api/hibp': {
                'post': {
                    ...
                    'requestBody': {
                        'required': True,
                        'content': {'application/json': {'schema': {'$ref': '#/components/schemas/HIBPQuery'}}}},
        ...
        'components': {
            'schemas': {
                'EmailQuery': {'type': 'object', 'required': ['email'],
                               'properties': {'email': {'type': 'string', 'format': 'email'}}},
                'IPQuery': {'type': 'object', 'required': ['ip'],
                            'properties': {'ip': {'type': 'string', 'format': 'ipv4'}}},
                'DomainQuery': {'type': 'object', 'required': ['domain'],
                                'properties': {'domain': {'type': 'string'}}},
                'OpenKVKQuery': {'type': 'object', 'required': ['query'],
                                 'properties': {'query': {'type': 'string'}}},
                'WebcamQuery': {'type': 'object', 'required': ['query'],
                                'properties': {'query': {'type': 'string'}, 'country': {'type': 'string'}}},
                'HIBPQuery': {'type': 'object', 'required': ['email'],
                              'properties': {'email': {'type': 'string', 'format': 'email'}}},
            }
        }
    }
