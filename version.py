...
CHANGELOG = {
    (
        ...
        0,
        0,
    ): "Initial Release - Core OSINT tools (Email, Username, Social Media, People Search)",
    (
        1,
        1,
        0,
    ): "Dark/Light mode, False positive filtering, Phone lookup, Combined email search, Platform health dashboard",
    (
        1,
        2,
        0,
    ): "AI Assistant with Ollama integration, Natural language search, AI result summaries",
    (
        2,
        0,
        0,
    ): "Major UI overhaul with toolbar, Combined tools, Confidence scoring, Real-time streaming",
    (
        2,
        1,
        0,
...
if __name__ == "__main__":
    ...
    if args.bump:
        ...
        new_content = content.replace(f"VERSION = {VERSION}", f"VERSION = {new_ver}")
        ...
        try:
            ...
            subprocess.run(
                ["git", "commit", "-m", f"Bump version to {tag}"], check=True
            )
