...
def upgrade() -> None:
    ...
    with op.batch_alter_table('addresses', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_addresses_subject_id'), ['subject_id'], unique=False)
    ...
    with op.batch_alter_table('contacts', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_contacts_subject_id'), ['subject_id'], unique=False)
    ...
    with op.batch_alter_table('phone_lookups', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_phone_lookups_phone'), ['phone'], unique=False)
    ...
    with op.batch_alter_table('social_accounts', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_social_accounts_subject_id'), ['subject_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_social_accounts_username'), ['username'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['related_subject_id'], ['subjects.id'], ),
    sa.ForeignKeyConstraint(['subject_id'], ['subjects.id'], ),
    ...
    op.create_table('osint_searches',
    sa.Column('id', sa.String(length=36), nullable=False),
    ...
    with op.batch_alter_table('osint_searches', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_osint_searches_search_id'), ['search_id'], unique=True)
        batch_op.create_index(batch_op.f('ix_osint_searches_status'), ['status'], unique=False)
    ...
    with op.batch_alter_table('reminders', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_reminders_is_completed'), ['is_completed'], unique=False)
        batch_op.create_index(batch_op.f('ix_reminders_is_overdue'), ['is_overdue'], unique=False)
    ...
    op.create_table('spiderfoot_scans',
    sa.Column('id', sa.String(length=36), nullable=False),
    ...
    with op.batch_alter_table('spiderfoot_scans', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_spiderfoot_scans_scan_id'), ['scan_id'], unique=False)
